...
const map<pair<int, int>, string> completedItems = {{{1, 1}, "Deathblade"},
                                                ...
                                                {{2, 7}, "Titan's Resolve"},
                                                {{2, 8}, "Steadfast Heart"},
                                                {{2, 9}, "Elderwood Emblem"},
                                                {{2, 10}, "Protector's Vow"},

                                                {{3, 3}, "Tactician's Shield"},
                                                {{3, 4}, "Brawler Emblem"},
                                                {{3, 5}, "Spellweaver Emblem"},
                                                {{3, 6}, "Ravager Emblem"},
                                                {{3, 7}, "Rapidfire Emblem"},
                                                {{3, 8}, "Executioner Emblem"},
...
namespace Set18 {
    ...
    const unordered_map<int, Vector3> hitboxScales = {
            ...
            {Set18::Kobuko.id, {0.7f, 1.0f, 1.0f}},
            {Set18::Leona.id, {0.3f, 0.7f, 1.0f}},
            {Set18::Ornn.id, {0.25f, 0.9f, 0.7f}},
            {Set18::Pebbles.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Rakan.id, {0.25f, 0.8f, 0.6f}},
            {Set18::RekSai.id, {0.65f, 0.3f, 0.8f}},
            {Set18::Varus.id, {0.5f, 0.6f, 1.0f}},
            {Set18::Veigar.id, {0.6f, 0.7f, 0.6f}},
            {Set18::Xayah.id, {0.25f, 1.0f, 0.5f}},
            {Set18::Yorick.id, {0.55f, 0.8f, 0.4f}},

            {Set18::Alistar.id, {0.60f, 1.0f, 0.7f}},
            {Set18::Caitlyn.id, {0.55f, 1.0f, 0.6f}},
            {Set18::Elise.id, {0.2f, 0.3f, 1.0f}},
            {Set18::Gromp.id, {0.8f, 0.7f, 0.6f}},
            {Set18::Kayle.id, {0.3f, 0.6f, 0.6f}},
            {Set18::LeBlanc.id, {0.35f, 0.8f, 0.35f}},
            {Set18::Murkwolf.id, {1.0f, 1.0f, 0.7f}},
            {Set18::Scuttlecrab.id, {0.8f, 0.8f, 0.8f}},
            {Set18::Sejuani.id, {0.8f, 0.7f, 0.5f}},
            {Set18::Shen.id, {0.5f, 1.0f, 1.3f}},
            {Set18::Teemo.id, {1.0f, 1.0f, 0.7f}},
            {Set18::Warwick.id, {0.5f, 0.75f, 0.30f}},
            {Set18::Yunara.id, {0.6f, 1.0f, 0.7f}},

            {Set18::Azir.id, {0.2f, 0.6f, 0.15f}},
            {Set18::Cassiopeia.id, {0.4f, 0.7f, 0.25f}},
            {Set18::Diana.id, {0.3f, 0.75f, 0.8f}},
            {Set18::Fiddlesticks.id, {0.15f, 0.4f, 0.5f}},
            {Set18::Hecarim.id, {0.7f, 0.55f, 0.6f}},
            {Set18::KhaZix.id, {0.4f, 0.8f, 0.8f}},
            {Set18::KogMaw.id, {0.4f, 0.6f, 0.5f}},
            {Set18::Krug.id, {1.0f, 1.0f, 1.0f}},
            {Set18::MamaBeak.id, {1.0f, 1.0f, 0.8f}},
            {Set18::MasterYi.id, {0.8f, 0.7f, 1.0f}},
            {Set18::Rammus.id, {0.2f, 0.3f, 0.4f}},
            {Set18::Rengar.id, {0.7f, 0.7f, 0.5f}},
            {Set18::Tristana.id, {0.7f, 1.0f, 0.6f}},
            {Set18::Vi.id, {0.3f, 0.9f, 0.7f}},

            {Set18::Ahri.id, {0.3f, 0.8f, 0.3f}},
            {Set18::Amumu.id, {0.6f, 0.8f, 1.0f}},
            {Set18::Aphelios.id, {0.3f, 0.5f, 0.4f}},
            {Set18::Brambleback.id, {0.6f, 0.8f, 1.0f}},
            {Set18::Ezreal.id, {0.7f, 1.0f, 1.0f}},
            {Set18::Lillia.id, {0.3f, 0.6f, 0.5f}},
            {Set18::Malphite.id, {0.5f, 0.8f, 0.7f}},
            {Set18::Morgana.id, {0.3f, 0.8f, 0.8f}},
            {Set18::Nidalee.id, {0.6f, 0.7f, 1.0f}},
            {Set18::Sentinel.id, {0.6f, 1.0f, 1.0f}},
            {Set18::Sett.id, {0.7f, 0.9f, 0.3f}},
            {Set18::Sivir.id, {0.7f, 0.8f, 0.5f}},
            {Set18::Soraka.id, {0.15f, 0.4f, 0.8f}},
            {Set18::Zyra.id, {0.4f, 1.0f, 1.0f}},

            {Set18::Alune.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Ashe.id, {0.3f, 0.8f, 1.0f}},
            {Set18::Draven.id, {0.2f, 1.0f, 1.0f}},
            {Set18::ElderDragon.id, {0.25f, 0.6f, 0.7f}},
            {Set18::Gnar.id, {0.5f, 0.7f, 0.5f}},
    ...
    const unordered_map<int, Vector3> hitboxOffsets = {
        ...
        {Set18::Ornn.id, {0.17f, 0.0f, 0.0f}},
        {Set18::Pebbles.id, {0.0f, 0.0f, 0.0f}},
        {Set18::Rakan.id, {0.1f, 0.0f, 0.1f}},
        {Set18::RekSai.id, {0.0f, 0.0f, 0.0f}},
        {Set18::Varus.id, {0.1f, 0.0f, 0.0f}},
        ...
        {Set18::Kayle.id, {0.0f, 0.3f, 0.5f}},
        {Set18::LeBlanc.id, {0.0f, 0.0f, 0.0f}},
        {Set18::Murkwolf.id, {-0.1f, 0.0f, 0.2f}},
        {Set18::Scuttlecrab.id, {0.0f, 0.0f, 0.0f}},
        {Set18::Sejuani.id, {0.1f, 0.0f, 0.2f}},
        {Set18::Shen.id, {0.2f, 0.0f, 0.3f}},
        {Set18::Teemo.id, {0.0f, 0.0f, 0.0f}},
        {Set18::Warwick.id, {0.0f, 0.0f, 0.1f}},
        ...
        {Set18::Hecarim.id, {0.0f, 0.0f, 0.2f}},
        ...
        {Set18::Ahri.id, {0.1f, 0.0f, 0.15f}},
        {Set18::Amumu.id, {0.1f, 0.0f, 0.0f}},
        ...
        {Set18::Malphite.id, {0.05f, 0.0f, 0.2f}},
        ...
        {Set18::Draven.id, {0.0f, 0.0f, 0.3f}},
    ...
    const map<pair<int,int>, int> emblemTraits = {
        {{1,3}, 19}, // hunter
        {{1,9}, 16}, // fae
        {{2,3}, 36}, // vanguard
        {{2,9}, 13}, // elderwood
