...
namespace Set18 {
    ...
    const unordered_map<int, Vector3> hitboxScales = {
            ...
            {Set18::Rakan.id, {0.35f, 1.0f, 0.8f}},
            {Set18::RekSai.id, {0.75f, 0.5f, 1.0f}},
            {Set18::Varus.id, {0.8f, 1.0f, 1.0f}},
            ...
            {Set18::Caitlyn.id, {0.8f, 1.0f, 0.7f}},
            {Set18::Elise.id, {0.25f, 0.3f, 1.0f}},
            {Set18::Gromp.id, {1.0f, 1.0f, 0.6f}},
            {Set18::Kayle.id, {0.5f, 1.0f, 1.0f}},
            {Set18::LeBlanc.id, {0.5f, 1.0f, 0.5f}},
            {Set18::Murkwolf.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Scuttlecrab.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Sejuani.id, {1.0f, 0.7f, 0.6f}},
            {Set18::Shen.id, {0.5f, 1.0f, 1.3f}},
            {Set18::Teemo.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Warwick.id, {0.7f, 1.0f, 0.55f}},
            {Set18::Yunara.id, {0.7f, 1.0f, 0.7f}},

            {Set18::Azir.id, {0.5f, 0.7f, 0.25f}},
            {Set18::Cassiopeia.id, {0.6f, 1.0f, 0.3f}},
            {Set18::Diana.id, {0.6f, 1.0f, 1.0f}},
            {Set18::Fiddlesticks.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Hecarim.id, {1.0f, 1.0f, 1.0f}},
            {Set18::KhaZix.id, {1.0f, 1.0f, 1.0f}},
            {Set18::KogMaw.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Krug.id, {1.0f, 1.0f, 1.0f}},
            {Set18::MamaBeak.id, {1.0f, 1.0f, 1.0f}},
            {Set18::MasterYi.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Rammus.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Rengar.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Tristana.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Vi.id, {1.0f, 1.0f, 1.0f}},

            {Set18::Ahri.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Amumu.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Aphelios.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Brambleback.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Ezreal.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Lillia.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Malphite.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Morgana.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Nidalee.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Sentinel.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Sett.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Sivir.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Soraka.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Zyra.id, {1.0f, 1.0f, 1.0f}},

            {Set18::Alune.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Ashe.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Draven.id, {1.0f, 1.0f, 1.0f}},
            {Set18::ElderDragon.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Gnar.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Ivern.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Kennen.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Lux.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Maokai.id, {1.0f, 1.0f, 1.0f}},
            {Set18::Taric.id, {1.0f, 1.0f, 1.0f}}
        };
    ...
    const unordered_map<int, Vector3> hitboxOffsets = {
        ...
        {Set18::Lillia.id, {0.0f, 0.0f, 0.0f}},
        {Set18::Malphite.id, {0.0f, 0.0f, 0.0f}},
        {Set18::Morgana.id, {0.0f, 0.0f, 0.0f}},
        {Set18::Nidalee.id, {0.0f, 0.0f, 0.0f}},
        {Set18::Sentinel.id, {0.0f, 0.0f, 0.0f}},
        {Set18::Sett.id, {0.0f, 0.0f, 0.0f}},
        {Set18::Sivir.id, {0.0f, 0.0f, 0.0f}},
        {Set18::Soraka.id, {0.0f, 0.0f, 0.0f}},
        {Set18::Zyra.id, {0.0f, 0.0f, 0.0f}},

        {Set18::Alune.id, {0.0f, 0.0f, 0.0f}},
        {Set18::Ashe.id, {0.0f, 0.0f, 0.0f}},
        {Set18::Draven.id, {0.0f, 0.0f, 0.0f}},
        {Set18::ElderDragon.id, {0.0f, 0.0f, 0.0f}},
        {Set18::Gnar.id, {0.0f, 0.0f, 0.0f}},
        {Set18::Ivern.id, {0.0f, 0.0f, 0.0f}},
        {Set18::Kennen.id, {0.0f, 0.0f, 0.0f}},
        {Set18::Lux.id, {0.0f, 0.0f, 0.0f}},
        {Set18::Maokai.id, {0.0f, 0.0f, 0.0f}},
        {Set18::Taric.id, {0.0f, 0.0f, 0.0f}}
    };
}
